    ...
    <div className="hidden lg:block">
      <aside className="w-64 h-screen p-4 border-r bg-white flex flex-col justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 mt-4 text-sm font-medium text-gray-800 hover:bg-red-100 transition"
        >
          <LogOut size={20} />
          Cerrar sesión
        </button>
